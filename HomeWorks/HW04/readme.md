...
Введем команду tracert на PC-A, чтобы проверить наличие сквозного подключения к PC-B.
...
Потому что такая адресация распространяется только на текущий канал и не выходит за пределы порта маршрутизатора.

### 2.	Какой идентификатор подсети в индивидуальном IPv6-адресе 2001:db8:acad::aaaa:1234/64?

Идентификатор подсети: 2001:db8:acad::/64
